...
function generateTestData() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield mongoose_1.default.connect('mongodb://172.100.0.30:27017/fakebook').then((_) => {
            ...
            // }));
            const usersResult = yield User_1.User.insertMany(userData);
            ...
            yield Friendship_1.Friendship.insertMany(friendshipData);
            ...
            const postResult = yield Post_1.Post.insertMany(postData);
            ...
            yield Comment_1.Comment.insertMany(commentData);
